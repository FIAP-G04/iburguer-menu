...
{
    public class RemoveMenuItemFromMenuUseCase
    {
        private readonly IMenuRepository _repository;

        private readonly RemoveItemFromMenuUseCase _manipulator;

        public RemoveMenuItemFromMenuUseCase()
        {
        ...
        [Fact]
        public async Task ShouldThrowErrorWhenMenuItemNotFound()
        {
            ...
            var action = () => _manipulator.RemoveItem(itemId);

            await action.Should().ThrowAsync<MenuItemNotFound>();
        }

        [Fact]
        public async Task ShouldRemoveItemFromMenu()
        {
            var item = new Item(
            ...
            await _manipulator.RemoveItem(item.Id);
